...
#allow customization of emojis used
if [[ -z "$PROMPT_EMOJIS" ]]; then
	PROMPT_EMOJIS=("🔥" "💀" "👑" "😎" "🐸" "🐵" "🦄" "🌈" "🍻" "🚀" "💡" "🎉" "🔑" "🚦" "🌙")
fi
...
prompt_status() {
  ...
  RAND_EMOJI_N=$(( $RANDOM % ${#PROMPT_EMOJIS[@]} + 1))
  [[ -n "$symbols" ]] || prompt_segment blue default "${PROMPT_EMOJIS[$RAND_EMOJI_N]}"
